// Test Phase 4: Context Layer
// Tests ContextInfo with ChatTemplateManager integration
// Tests dynamic template management and message processing
// Tests template-based context rebuilding
...
void TestSummarizationCallbacks() {
    ...
    // In real implementation, this would be automatic based on token count
...
int main() {
    std::cout << "=== LuminaChat Phase 4 Context Layer Test ===" << std::endl;
    ...
    try {
        ...
        TestContextRebuilding();
        std::cout << std::endl;
        
        TestSummarizationCallbacks();
        std::cout << std::endl;
        
        TestPastSessionMemories();
        std::cout << std::endl;
        ...
        std::cout << "Phases 1-4 are complete and validated!" << std::endl;
        std::cout << "Ready for Phase 5: Management Layer" << std::endl;
