...
#define LOG_ContextPruning(message) LOG_INFO("ContextPruning", message)
...
#define LOG_DEBUG_ContextPruning(message) LOG_DEBUG("ContextPruning", message)
...
#define LOG_ERROR_ContextPruning(message) LOG_ERROR("ContextPruning", message)
...
#define LOG_WARNING_ContextPruning(message) LOG_WARNING("ContextPruning", message)
...
#define CONTEXT_SIZE_LOG(message) LOG_INFO("ContextPruning", message)
#define CONTEXT_SIZE_LOG_DEBUG(message) LOG_DEBUG("ContextPruning", message)
#define CONTEXT_SIZE_LOG_ERROR(message) LOG_ERROR("ContextPruning", message)
